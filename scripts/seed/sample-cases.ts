// The 8 demo cases seeded by scripts/db-setup.ts. Sample IDs are pp-1001..pp-1008; owner
// submissions start at pp-1009, so re-seeding never touches them.
import type { CaseIntake } from "@/lib/vet/schema";

export interface SampleCase extends CaseIntake {
  id: string;
  minutesAgo: number;
  status: "new" | "reviewed";
  photoCredit?: string;
...
export const SAMPLE_CASES: SampleCase[] = [
  {
    ...
    photoCredit: "Photo: Maja Dumat, CC BY 2.0, via Wikimedia Commons",
  },
  {
    id: "pp-1002",
    minutesAgo: 45,
    ...
    photoCredit: "Photo: Kalumet, CC BY-SA 4.0, via Wikimedia Commons",
  },
  {
    id: "pp-1003",
    minutesAgo: 80,
  ...
  },
  {
    ...
    photoCredit: "Photo: Caroldermoid, CC BY-SA 3.0, via Wikimedia Commons",
  },
  {
    id: "pp-1005",
    minutesAgo: 140,
